...
class User extends Authenticatable
{
    ...
    protected $fillable = [
        ...
        'eat_allowance', 'transportation_allowance', 'medical_allowance', 'bpjs_tk', 'bpjs_ke', 'incentive', 'position', 'work_activation_date', 'has_workshop_allowance', 'workshop_allowance_amount',
    ];
