...
@section('content')
    ...
    <div class="col-lg-12">
        <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">My ETS</h3>
              <a href="javascript::void()" id="btn-import-ets" class="btn btn-primary pull-right" title="Import My ETS">
  ...
  <div class="modal fade" id="modal-import-ets" tabindex="-1" role="dialog" aria-labelledby="modal-import-etsLabel">
    <div class="modal-dialog" role="document">
      ...
      {!! Form::open(['url'=>'ets/importMyEts', 'role'=>'form', 'class'=>'form-horizontal', 'method'=>'post', 'id'=>'form-import-file', 'files'=>true]) !!}
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title" id="modal-import-etsLabel">Import My Ets</h4>
        </div>
