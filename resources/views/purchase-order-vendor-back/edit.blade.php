                  ...
                  <table id="table-items" class="table">
                    ...
                    <tfoot>
                      <tr>
                        ...
                        <td><input type="text" name="total_sub_amount" id="total_sub_amount" class="form-control" value="{{ $purchase_order_vendor->sub_amount }}" readonly></td>
                        <td></td>
                      </tr>
                    </tfoot>
                  </table>
          ...
          <div class="form-group{{ $errors->has('discount_value') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-10">
              <?php 
                ...
                if($purchase_order_vendor->discount !=0){
                  $org_discount_value = $purchase_order_vendor->discount / 100 * $purchase_order_vendor->sub_amount;
                }
              ?>
