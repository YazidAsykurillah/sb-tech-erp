    ...
    <div class="col-md-12">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Form Create Bank Administration</h3>
        </div><!-- /.box-header -->
        <div class="box-body">
          {!! Form::open(['route'=>'bank-administration.store','role'=>'form','class'=>'form-horizontal','id'=>'form-create-bank-administration','files'=>true]) !!}
          
          <div class="form-group{{ $errors->has('cash_id') ? ' has-error' : '' }}">
            {!! Form::label('cash_id', 'Cash', ['class'=>'col-sm-2 control-label']) !!}
            <div class="col-sm-10">
              {{ Form::select('cash_id', $cash_opts, null, ['class'=>'form-control', 'placeholder'=>'Select Cash', 'id'=>'cash_id']) }}
