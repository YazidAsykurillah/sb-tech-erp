    ...
    <div class="col-md-12">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Form Edit Cash</h3>
        </div><!-- /.box-header -->
        <div class="box-body">
          {!! Form::model($cash, ['route'=>['cash.update', $cash->id], 'class'=>'form-horizontal','method'=>'put', 'files'=>true]) !!}
          ...
          <div class="form-group{{ $errors->has('enabled') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-10">
              {{ Form::select('enabled', [1=>'Yes', 0=>'No'], null, ['class'=>'form-control', 'placeholder'=>'Select enabled', 'id'=>'enabled']) }}
