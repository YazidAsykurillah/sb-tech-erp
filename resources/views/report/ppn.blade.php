    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">List PPN</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
              <div class="table-responsive">
                  <table class="table table-bordered" id="table-list-ppn">
                    <thead>
                        <tr>
                          <th style="width:5%;">#</th>
...
@section('additional_scripts')
  <script type="text/javascript">
    var tableReportPPN =  $('#table-list-ppn').DataTable({
      processing :true,
      serverSide : true,
      ajax : "{!! url('report/data-ppn') !!}",
      columns :[
  ...
  tableReportPPN.on('click', '.btn-tax-in-detail', function(e){
  ...
  tableReportPPN.on('click', '.btn-tax-out-detail', function(e){
    var yearmonth = $(this).attr('data-yearmonth');
    param_yearmonth = yearmonth;
