            ...
            <table class="table">
              ...
              @foreach($time_reports as $time_report)
                <tr>
                  ...
                  <td>
                    <!-- if the day type is week end, the default allowance option is non allowance-->
                    @if($time_report->type == 'week_end')
                      {{ Form::select('allowance[]', $allowance_opts, ['non_allowance'] , ['class'=>'form-control allowance_input', 'placeholder'=>'--Select Allowance--']) }}
                    @else
                  ...
                  <td style="text-align:center;">
                    {!! Form::text('normal_time[]',null,['class'=>'form-control normal_time_input', 'placeholder'=>'Normal Time', 'readonly'=>($time_report->type=="week_end" ? true : false) ]) !!}
                  </td>
                  <td style="text-align: center; width: 10%;">
                    {!! Form::text('overtime_one[]',null,['class'=>'form-control overtime_input', 'placeholder'=>'Overtime I', 'readonly'=>($time_report->type=="week_end" ? true : false) ]) !!}
                  </td>
                  <td style="text-align: center; width: 10%;">
                    {!! Form::text('overtime_two[]',null,['class'=>'form-control overtime_input', 'placeholder'=>'Overtime II', 'readonly'=>($time_report->type=="week_end" ? true : false) ]) !!}
                  </td>
                  <td style="text-align: center; width: 10%;">
                    {!! Form::text('overtime_three[]',null,['class'=>'form-control overtime_input', 'placeholder'=>'Overtime III', 'readonly'=>($time_report->type=="week_end" ? true : false) ]) !!}
                  </td>
                  <td style="text-align: center; width: 10%;">
                    {!! Form::text('overtime_four[]',null,['class'=>'form-control overtime_input', 'placeholder'=>'Overtime IV', 'readonly'=>($time_report->type=="week_end" ? true : false) ]) !!}
                  </td>
                </tr>
              @endforeach
              </tbody>
...
@section('additional_scripts')
  ...
  <script type="text/javascript">
    ...
    $('.allowance_input').on('change', function(){
      ...
      //if non_allowance is selected, then disable all inputs along this row EXCEPT the date
      if(the_val == 'non_allowance'){
