    ...
    <div class="col-md-12">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Form Edit period</h3>
        </div><!-- /.box-header -->
        <div class="box-body">
          {!! Form::model($period, ['route'=>['period.update', $period->id], 'role'=>'form', 'class'=>'form-horizontal', 'id'=>'form-edit-period', 'method'=>'put', 'files'=>true]) !!}
