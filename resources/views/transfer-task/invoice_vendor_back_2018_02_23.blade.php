        ...
        <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <div class="pull-right">
                ...
                <button type="button" id="btn-approve-multiple">Approve Multiple</button>
                @endif
              </div>
...
@section('additional_scripts')
   <script type="text/javascript">
    ...
    var selected_internal_request_ids = tableInvoiceVendor.rows('.selected').data();
    $.each( selected_internal_request_ids, function( key, value ) {
      selectedInvoiceVendor.push(selected_internal_request_ids[key].id);
    });
