    ...
    <div class="col-md-12">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Form Update Customer</h3>
        </div><!-- /.box-header -->
        <div class="box-body">
          {!! Form::model($customer, ['route'=>['customer.update', $customer->id], 'class'=>'form-horizontal','id'=>'form-edit-customer', 'method'=>'put', 'files'=>true]) !!}
