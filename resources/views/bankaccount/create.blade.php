...
@section('page_header')
  <h1>
    Bank Account
    <small>Create Bank Account</small>
  </h1>
@endsection
...
@section('breadcrumb')
  <ol class="breadcrumb">
    ...
    <li><a href="{{ URL::to('bank_account') }}"><i class="fa fa-dashboard"></i> Bank Account</a></li>
    ...
    <div class="col-md-12">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Form Create Bank Account</h3>
        </div><!-- /.box-header -->
        <div class="box-body">
          {!! Form::open(['route'=>'bank-account.store','role'=>'form','class'=>'form-horizontal','id'=>'form-create-bank-account','files'=>true]) !!}

          <div class="form-group{{ $errors->has('user_id') ? ' has-error' : '' }}">
            {!! Form::label('user_id', 'Owner', ['class'=>'col-sm-2 control-label']) !!}
            <div class="col-sm-10">
              {!! Form::text('user_name',\Auth::user()->name,['class'=>'form-control', 'placeholder'=>'user_name of the bank', 'id'=>'user_name', 'disabled'=>true]) !!}
              {!! Form::hidden('user_id',\Auth::user()->id,['class'=>'form-control', 'placeholder'=>'user_id of the bank', 'id'=>'user_id']) !!}
