      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <div class="form-group{{ $errors->has('project_id') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-10">
              {!! Form::text('project_name',null,['class'=>'form-control', 'placeholder'=>'Project Name', 'id'=>'project_name', 'readonly'=>true]) !!}
          ...
          <div class="form-group{{ $errors->has('amount_before_type') ? ' has-error' : '' }}">
            {!! Form::label('amount_before_type', 'PO Amount', ['class'=>'col-sm-2 control-label']) !!}
            <div class="col-sm-3">
              {!! Form::text('amount_before_type',null,['class'=>'form-control', 'placeholder'=>'', 'id'=>'amount_before_type', 'readonly'=>true]) !!}
    ...
    <div class="col-md-3">
      <div class="box box-default">
        ...
        <div class="box-body">
          ...
          <p>
            {!! Form::text('po_vendor_code',null,['class'=>'form-control', 'placeholder'=>'PO Vendor Code', 'id'=>'po_vendor_code', 'readonly'=>true]) !!}
          </p>
