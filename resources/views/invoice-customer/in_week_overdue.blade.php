...
@section('page_header')
  <h1>
    Overdue Invoice Customer
    <small>Overdue Invoice Customer in this week</small>
  </h1>
@endsection
...
@section('breadcrumb')
  <ol class="breadcrumb">
    ...
    <li class="active"><i></i> Overdue in this week</li>
  </ol>
@endsection
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
              <p class="alert alert-info">
                <i class="fa fa-info-circle"></i>&nbsp;Below are the invoice customers that will be overdued within this week ( {{ $from }} to {{ $next_week}} )
              </p>
              <div class="table-responsive">
                <table class="table table-bordered" id="table-invoice-customer-in-week-overdue">
                  <thead>
                    <tr>
                      <th style="width:5%;">#</th>
...
@section('additional_scripts')
   <script type="text/javascript">
    var tableInvoiceCustomerInWeekOverDue =  $('#table-invoice-customer-in-week-overdue').DataTable({
      processing :true,
      serverSide : true,
      ajax : '{!! route('datatables.getInvoiceCustomersInWeekOverDue') !!}',
      columns :[
    ...
    tableInvoiceCustomerInWeekOverDue.on('click', '.btn-delete-invoice-customer', function(e){
    ...
    $('#searchColumn input').keyup(function() {
      tableInvoiceCustomerInWeekOverDue.columns($(this).data('id')).search(this.value).draw();
    });
