...
@section('page_header')
  <h1>
    Invoice Customer
    <small>Create Invoice Customer</small>
  </h1>
@endsection
    ...
    <div class="col-md-9">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Form Create Invoice Customer</h3>
        </div><!-- /.box-header -->
        <div class="box-body">
          
          {!! Form::open(['route'=>'invoice-customer.store','role'=>'form','class'=>'form-horizontal','id'=>'form-create-invoice-customer','files'=>true]) !!}
          
          <div class="form-group{{ $errors->has('project_id') ? ' has-error' : '' }}">
            {!! Form::label('project_id', 'Project', ['class'=>'col-sm-2 control-label']) !!}
            <div class="col-sm-10">
              {!! Form::text('project_code',$project->code,['class'=>'form-control', 'placeholder'=>'Project CODE of the invoice', 'id'=>'project_code', 'disabled'=>true]) !!}
              {!! Form::hidden('project_id',$project->id,['class'=>'form-control', 'placeholder'=>'Project ID of the invoice', 'id'=>'project_id']) !!}
              ...
              <div class="table-responsive">
                <table id="table-items" class="table">
                  ...
                  <tbody id="table_items_body">
                    ...
                    @else
                      <!-- Project already has related invoice customers -->
                      @if($project->invoice_customer->count())
                        <?php $items = \DB::table('item_invoice_customer')->where('invoice_customer_id', '=', $project->invoice_customer->last()->id)->get(); ?>
                        @if(count($items))
                          <?php $item_counter = 0; ?>
                        ...
                        @else
                        @endif
                      <!-- Project doesnt related to any invoice customers-->
                      @else
                      <tr id="row_index_0">
          ...
          <div class="form-group{{ $errors->has('down_payment_value') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-4">
                {!! Form::text('down_payment_value',null,['class'=>'form-control', 'placeholder'=>'DP/Term/Pelunasan Value', 'id'=>'down_payment_value', 'readonly'=>true]) !!}
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <a href="{{ url('invoice-customer') }}" class="btn btn-default">
...
@section('additional_scripts')
  ...
  <script type="text/javascript">
    ...
    //run value initializator functions
    fill_total_sub_amount();
    update_after_discount_value();
    update_down_payment_value_value();
    update_vat_value_value();
